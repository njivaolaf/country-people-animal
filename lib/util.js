 ...
 * @param   {String} argName - argument name - e.g: filter in the case of our project --- assuming that the format e.g is as follow :   --filter=data
 * @returns {Object} {found:Boolean, value: string}
 */
